function data = getDataSet(labels)
    ...
    for label = transpose(labels)
        ...
        nomeImagemPrimaria = '\16_L_N_L_BH.tif';
        nomeImagemSecundaria = '\16_L_N_L_BH_1.tif';
        nomeImagemTerciaria = '\16_L_N_L_BH_01.tif';
        nomeImagemQuaternaria = '\16_L_N_L_BH_2.tif';
...
%         nomeImagemTerciaria = '\08_R_N_L_P_01.tif';
        ...
        elseif isfile(strcat(folderName, nomeImagemTerciaria))
            img = imread(strcat(folderName, nomeImagemTerciaria));
        else
            img = imread(strcat(folderName, nomeImagemQuaternaria));
        end
